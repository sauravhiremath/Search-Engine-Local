#-------------------------------------------------------------------------------------------
#	Without stemming and pickling and multi-threading
#-------------------------------------------------------------------------------------------
...
class BuildIndex:
	...
	def process_files(self):
		...
		for file in self.filenames:
			...
			file_to_terms[file] = [w for w in file_to_terms[file] if w not in stopword]
...
if __name__ == "__main__":
	...
	json_file = './inverted_file_IBST_totalIndex(Stopwords).json'
	with open(json_file, 'w') as fh:
		json.dump(ff.totalIndex, fh)
